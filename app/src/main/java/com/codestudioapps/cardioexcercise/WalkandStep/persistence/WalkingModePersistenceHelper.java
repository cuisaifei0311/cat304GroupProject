...
package com.codestudioapps.cardioexcercise.WalkandStep.persistence;
...
public class WalkingModePersistenceHelper {
    ...
    public static final String BROADCAST_ACTION_WALKING_MODE_CHANGED = "com.codestudioapps.cardioexcercise.WALKING_MODE_CHANGED";
    public static final String BROADCAST_EXTRA_OLD_WALKING_MODE = "com.codestudioapps.cardioexcercise.EXTRA_OLD_WALKING_MODE";
    public static final String BROADCAST_EXTRA_NEW_WALKING_MODE = "com.codestudioapps.cardioexcercise.EXTRA_NEW_WALKING_MODE";
