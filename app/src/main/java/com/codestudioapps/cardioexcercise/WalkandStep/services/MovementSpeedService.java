...
public class MovementSpeedService extends IntentService implements LocationListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_SPEED_CHANGED = "com.codestudioapps.cardioexcercise.SPEED_CHANGED";


    public static final String EXTENDED_DATA_CURRENT_SPEED = "com.codestudioapps.cardioexcercise.CURRENT_SPEED";
