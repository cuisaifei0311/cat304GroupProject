...
public class StepCountPersistenceHelper {
    ...
    public static final String BROADCAST_ACTION_STEPS_SAVED = "com.codestudioapps.cardioexcercise.STEPS_SAVED";
    public static final String BROADCAST_ACTION_STEPS_UPDATED = "com.codestudioapps.cardioexcercise.STEPS_UPDATED";
    public static final String BROADCAST_ACTION_STEPS_INSERTED = "com.codestudioapps.cardioexcercise.STEPS_INSERTED";
