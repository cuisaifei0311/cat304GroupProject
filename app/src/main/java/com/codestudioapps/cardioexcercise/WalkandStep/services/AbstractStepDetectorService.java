...
package com.codestudioapps.cardioexcercise.WalkandStep.services;
...
import com.codestudioapps.cardioexcercise.WalkandStep.activities.TrainingActivity;
...
import com.codestudioapps.cardioexcercise.WalkandStep.persistence.TrainingPersistenceHelper;
...
import com.codestudioapps.cardioexcercise.WalkandStep.utils.UnitHelper;
...
public abstract class AbstractStepDetectorService extends IntentService implements SensorEventListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_STEPS_DETECTED = "com.codestudioapps.cardioexcercise.STEPS_DETECTED";

    public static final String EXTENDED_DATA_NEW_STEPS = "com.codestudioapps.cardioexcercise.NEW_STEPS";

    public static final String EXTENDED_DATA_TOTAL_STEPS = "com.codestudioapps.cardioexcercise.TOTAL_STEPS";
